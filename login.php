<?php
  ...
  if(empty($_SESSION['logged_in'])){
    ...
    $_SESSION['logged_in'] = $usr_email;

    //echo "<script>alert(email: $usr_email);</script>";
    //echo "<script>alert(pass: $usr_passw);</script>";
    //"<p><h3>email: $usr_email</h3></p>";
